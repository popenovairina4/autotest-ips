...
import { MainNegativeIssues } from "../pagobject.ts/Issues.negative.main"
import { IssuesPage } from "../pagobject.ts/IssuesPage"
import { createUserModel, UserModel } from "../../Users/model/user.model"
import { LoginPage } from "../../Users/Login.page"
import { createIssues } from "../data/issues"
...
describe('Profile form', () => {
    ...
    it('Positive create issues', async () => {
        await issuesPage.settings(createIssues)

        await browser.pause(3000)

        const isDisplayedElement: boolean = await mainIssues.isDisplayedMainSettings()
    ...
    it('Only title', async () => {
        ...
        await issuesPage.settings({ ...createIssues, title: onlytitle })
